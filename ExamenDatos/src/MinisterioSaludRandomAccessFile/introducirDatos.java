...
public class introducirDatos {
    ...
    public static void main(String[] args) {
        ...
        double[] presupuesto = {2252257.54, 3253254.78, 52542547.87}; // Notar que he corregido el punto decimal aquí
        ...
        try {
            ...
            for (int i = 0; i < codigo.length; i++) {
                ...
                buffer.setLength(25); // Aseguramos que tenga longitud 25
                file.writeChars(buffer.toString());

                // Escribir dirección con longitud de 35
                buffer = new StringBuffer(direccion[i]);
                buffer.setLength(35); // Aseguramos que tenga longitud 35
                file.writeChars(buffer.toString());
